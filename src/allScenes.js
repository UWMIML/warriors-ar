...
import sceneAGLTF from './sceneA.gltf';
import sceneBGLTF from './sceneB.gltf';
import sceneCGLTF from './sceneC.gltf';
import sceneDGLTF from './sceneD.gltf';
import sceneEGLTF from './sceneE.gltf';
import sceneFGLTF from './sceneF.gltf';
import markerAPattern from './patterns/letterA.patt';
import markerBPattern from './patterns/letterB.patt';
import markerCPattern from './patterns/letterC.patt';
import markerDPattern from './patterns/letterD.patt';
import markerEPattern from './patterns/kanji.patt';
import markerFPattern from './patterns/letterF.patt';
...
ready(function() {
  ...
  const models = [
    { mesh: sceneAGLTF, pattern: markerAPattern },
    { mesh: sceneBGLTF, pattern: markerBPattern },
    { mesh: sceneCGLTF, pattern: markerCPattern },
    { mesh: sceneDGLTF, pattern: markerDPattern },
    { mesh: sceneEGLTF, pattern: markerEPattern },
    { mesh: sceneFGLTF, pattern: markerFPattern },
  ];
